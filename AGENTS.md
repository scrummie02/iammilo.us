...
- ⚡ Quick Q&A, facts, conversions, simple tasks → **qwen3.5:2b** (MILO) - Local Ollama
- 🟡 Drafts, summaries, rewrites, image analysis → **gemma4:e2b** (IGOR) - Local Ollama
...
- 🟩 Lightweight backup (Local) → **gemma4:e4b** - Local Ollama
