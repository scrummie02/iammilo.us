#!/bin/bash
# Boston Molasses Flood Video Assembly

set -e

WORKDIR="/home/dain/.openclaw/workspace/molasses_flood_scenes"
MEDIA_DIR="/home/dain/.openclaw/media/tool-image-generation"
OUTPUT="$WORKDIR/molasses_flood_short.mp4"
...
# Find all molasses scene images in order
IMAGES=($(ls -v "$MEDIA_DIR"/molasses_scene*_*.jpg 2>/dev/null | head -10))
...
echo ""
echo "✅ Molasses Flood video complete!"
echo "Output: $OUTPUT"
ls -lh "$OUTPUT"
